...
const PrivacyPolicy = () => {
  return (
    ...
    >
      <Text style={TermsStyles.titleStyle}> Privacy & Cookie Policy</Text>
      <View style={TermsStyles.margin10} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        HashPay And Our Affiliate Companies (Together "HashPay" Or "We" Or
        "Our") Are Totally Committed To Protecting And Respecting Your Privacy .
      </Text>
      <View style={TermsStyles.margin10} />
      ...
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        In this policy "information" refers to any confidential and/or personal
        data or other information related to users of HashPay services.
      </Text>
      ...
      <View style={TermsStyles.margin9} />
      <Text style={TermsStyles.titleStyle}>
        How to exercise your personal right
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
      ...
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        support@Hashgreed.com and 08128447600. We endeavor to reply to your
      ...
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        ...
        our registration, account upgrade or profile forms.
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
      ...
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        Our lawyers, HashPay may disclose your Personal Data if we believe it is
        reasonably necessary to comply with a law, regulation, order, subpoena,
        rule of a self-regulatory organization or audit or to protect the safety
        of any person, to address fraud, security or technical issues, or to
        protect our legal rights, interests and the interests of others, such
        as, for example, in connection with the acquisition, merger or sale of
      ...
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        ...
        may not be accessible to other Users, but other users may be able to
        infer certain facts about your activities and identity on HashPay.
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        n addition, HashPay advisers, Top level employees and lead investors may
        have access to your Personal Data to help them evaluate, invite and
      ...
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        ...
        promise that no one else will see that information on the Site, nor do
        we control what users who are allowed to see your information will do
        with it.As we develop our business, we may buy or sell businesses or
        assets. In the event of a corporate sale, merger, reorganization,
        dissolution or similar event, we may also transfer your Personal Data as
        part of the transferred assets without your consent or notice to you.
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
      ...
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        ...
        or to perform the terms of a contract we have with you
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        ...
        example, to provide you with the functionalities of the Services).
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        and you fail to provide that data when requested, we may not be able to
      ...
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        These processes are in place to prevent accidental, unlawful or
        unauthorized destruction, loss, alteration, access, disclosure or use of
        your information.
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
      ...
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        To achieve the purpose stated in this Privacy Policy,
      </Text>
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
      ...
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        This may include keeping your Personal Data after you have deactivAlso
        details of your transactions, if they are blockchain or cryptocurrency
        related may be recorded on our native and open distributed blockchain
        ledger called Kross blockchain or any such chains as the product might
        be built on.
      </Text>
      <View style={TermsStyles.margin9} />
      <Text style={TermsStyles.titleStyle}>
      ...
      <View style={TermsStyles.margin6} />
      <Text style={[styles.fontStyle, TermsStyles.paragraphStyle]}>
        Any Modifications Or Changes To The Privacy Policy Will Be Made On This
        Page And You Will Receive Notification Through All Our Channels Of
        Service. If You Are Opposed To The Changes, You May Close Your Account.
        Continuous Usage Of HashPay Services After Receipt Of Notification Means
        You Have Understood And Accepted The Modifications Or Changes
      </Text>
      <View style={TermsStyles.margin6} />
      <View style={TermsStyles.margin6} />
    </ScrollView>
